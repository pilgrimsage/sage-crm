...
/* Smarty version 4.5.7, created on 2026-09-23 21:18:30
  from '/Users/pilgrimsage/Desktop/Personal/vtigercrm/layouts/v7/modules/Settings/Vtiger/ModuleHeader.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.7',
  'unifunc' => 'content_6ab4422631a881_98970864',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '568a8fdfa66e3b43e3175c7b483b8f00856f7c74' => 
    array (
      0 => '/Users/pilgrimsage/Desktop/Personal/vtigercrm/layouts/v7/modules/Settings/Vtiger/ModuleHeader.tpl',
      1 => 1790019569,
      2 => 'file',
    ),
  ),
...
function content_6ab4422631a881_98970864 (Smarty_Internal_Template $_smarty_tpl) {
...
" href='index.php?module=Vtiger&parent=Settings&view=Index'><h4 class="module-title float-start text-uppercase"><?php echo vtranslate('LBL_HOME',$_smarty_tpl->tpl_vars['MODULE']->value);?>
 </h4></a>&nbsp;<span class="fa fa-angle-right float-start <?php if ($_smarty_tpl->tpl_vars['VIEW']->value == 'Index' && $_smarty_tpl->tpl_vars['MODULE']->value == 'Vtiger') {?> hide <?php }?>" aria-hidden="true" style="padding-top: 12px;padding-left: 5px; padding-right: 5px;"></span><?php }
if ($_smarty_tpl->tpl_vars['MODULE']->value != 'Vtiger' || $_smarty_tpl->tpl_vars['REQ']->value->get('view') != 'Index') {
if ($_smarty_tpl->tpl_vars['ACTIVE_BLOCK']->value['block']) {?><span class="current-filter-name filter-name float-start"><?php echo vtranslate($_smarty_tpl->tpl_vars['ACTIVE_BLOCK']->value['block'],$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
...
}?><span class="current-filter-name settingModuleName filter-name float-start"><?php if ($_smarty_tpl->tpl_vars['REQ']->value->get('view') == 'Calendar') {
...
}?><span class="current-filter-name filter-name float-start" style='width:50%;'><span class="display-inline-block"><?php ob_start();
echo $_smarty_tpl->tpl_vars['PAGETITLE']->value;
$_prefixVariable11 = ob_get_clean();
echo vtranslate($_prefixVariable11,$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
</span></span><?php }
}?></div><div class="col-lg-5 col-md-5 float-end"><div id="appnav" class="navbar-right"><ul class="nav navbar-nav"><?php
...
}?><li><div class="settingsIcon"><button type="button" class="btn btn-default module-buttons dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false" title="<?php echo vtranslate('LBL_SETTINGS',$_smarty_tpl->tpl_vars['MODULE']->value);?>
