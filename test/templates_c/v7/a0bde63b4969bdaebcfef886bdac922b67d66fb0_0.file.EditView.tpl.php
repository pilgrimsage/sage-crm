...
/* Smarty version 4.5.7, created on 2026-09-23 22:00:15
  from '/Users/pilgrimsage/Desktop/Personal/vtigercrm/layouts/v7/modules/Settings/Workflows/EditView.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.7',
  'unifunc' => 'content_6ab44bef2b77f2_34728411',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'a0bde63b4969bdaebcfef886bdac922b67d66fb0' => 
    array (
      0 => '/Users/pilgrimsage/Desktop/Personal/vtigercrm/layouts/v7/modules/Settings/Workflows/EditView.tpl',
      1 => 1790019570,
      2 => 'file',
    ),
  ),
...
function content_6ab44bef2b77f2_34728411 (Smarty_Internal_Template $_smarty_tpl) {
...
</label><div class="col-sm-5 controls"><?php if ((isset($_smarty_tpl->tpl_vars['MODE']->value)) && $_smarty_tpl->tpl_vars['MODE']->value == 'edit') {?><div class="float-start"><input type='text' disabled='disabled' class="inputElement" value="<?php echo vtranslate($_smarty_tpl->tpl_vars['MODULE_MODEL']->value->getName(),$_smarty_tpl->tpl_vars['MODULE_MODEL']->value->getName());?>
" ><input type='hidden' id="module_name" name='module_name' value="<?php echo $_smarty_tpl->tpl_vars['MODULE_MODEL']->value->get('name');?>
" ></div><?php } else { ?><select class="select2 col-sm-6 float-start" id="module_name" name="module_name" required="true" data-placeholder="Select Module..." style="text-align: left"><?php
...
</label><div class="col-sm-5 controls"><div class="float-start"><span style="margin-right: 10px;"><input name="status" type="radio" value="active" <?php if ($_smarty_tpl->tpl_vars['WORKFLOW_MODEL_OBJ']->value->status == '1') {?> checked="" <?php }?>>&nbsp;<span><?php echo vtranslate('Active',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
