<?php
/* Smarty version 4.5.7, created on 2026-09-23 21:18:47
  from '/Users/pilgrimsage/Desktop/Personal/vtigercrm/layouts/v7/modules/Vtiger/RecentComments.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.7',
  'unifunc' => 'content_6ab4423725aff4_98723434',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '993a4d207f5ce650b1355133a782e6ad6c1b934a' => 
    array (
      0 => '/Users/pilgrimsage/Desktop/Personal/vtigercrm/layouts/v7/modules/Vtiger/RecentComments.tpl',
      1 => 1790087695,
      2 => 'file',
    ),
  ),
...
function content_6ab4423725aff4_98723434 (Smarty_Internal_Template $_smarty_tpl) {
...
"></textarea></div></div></div><div class='row'><div class="col-xs-6 float-end paddingTop10 paddingLeft0"><div style="text-align: right;"><?php if (in_array($_smarty_tpl->tpl_vars['MODULE_NAME']->value,$_smarty_tpl->tpl_vars['PRIVATE_COMMENT_MODULES']->value)) {?><div class="" style="margin: 7px 0;"><label><input type="checkbox" id="is_private" style="margin:2px 0px -2px 0px" checked>&nbsp;&nbsp;<?php echo vtranslate('LBL_INTERNAL_COMMENT');?>
</label>&nbsp;&nbsp;<i class="fa fa-question-circle cursorPointer" data-bs-toggle="tooltip" data-placement="top" data-original-title="<?php echo vtranslate('LBL_INTERNAL_COMMENT_INFO');?>
...
</button></div></div><?php if ($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->getProfileReadWritePermission()) {?><div class="col-xs-6 paddingTop10 float-start"><?php $_smarty_tpl->_subTemplateRender(vtemplate_path($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->getUITypeModel()->getTemplateName(),$_smarty_tpl->tpl_vars['MODULE_NAME']->value), $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('MODULE'=>"ModComments"), 0, true);
...
</h4><?php if ($_smarty_tpl->tpl_vars['MODULE_NAME']->value != 'Leads') {?><div class="col-lg-5 commentHeader float-end" style="margin-top:5px;text-align:right;padding-right:20px;"><div class="display-inline-block"><span class=""><?php echo vtranslate('LBL_ROLL_UP',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
 &nbsp;</span><span class="fa fa-question-circle" data-bs-toggle="tooltip" data-placement="top" title="<?php echo vtranslate('LBL_ROLLUP_COMMENTS_INFO',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
"></span>&nbsp;&nbsp;</div><div class="form-check form-switch float-end"><input type="checkbox" class="form-check-input" role="switch" id="rollupcomments" hascomments="1" startindex="<?php echo $_smarty_tpl->tpl_vars['STARTINDEX']->value;?>
...
" checked data-on-color="success"/></div></div><?php }?></div><div class="commentsBody"><?php if (!empty($_smarty_tpl->tpl_vars['COMMENTS']->value)) {?><div class="recentCommentsBody container-fluid"><?php $_smarty_tpl->_assignInScope('COMMENTS_COUNT', php7_count($_smarty_tpl->tpl_vars['COMMENTS']->value));
...
</small></span>&nbsp;&nbsp;<?php if (in_array($_smarty_tpl->tpl_vars['MODULE_NAME']->value,$_smarty_tpl->tpl_vars['PRIVATE_COMMENT_MODULES']->value)) {?><span><?php if ($_smarty_tpl->tpl_vars['COMMENT']->value->get('is_private')) {?><i class="fa fa-lock" data-bs-toggle="tooltip" data-placement="top" data-original-title="<?php echo vtranslate('LBL_INTERNAL_COMMENT_TOOTLTIP',$_smarty_tpl->tpl_vars['MODULE']->value);?>
"></i><?php } else { ?><i class="fa fa-unlock" data-bs-toggle="tooltip" data-placement="top" data-original-title="<?php echo vtranslate('LBL_EXTERNAL_COMMENT_TOOTLTIP',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
...<a class="float-end toggleComment showMore" style="color: blue;"><small><?php echo vtranslate('LBL_SHOW_MORE',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</small></a><?php } else {
...
</span></small></span><?php }?><span <?php if ($_smarty_tpl->tpl_vars['REASON_TO_EDIT']->value) {?>class="col-lg-7 col-md-7 col-sm-7"<?php }?>><p class="text-muted float-end" <?php if (!$_smarty_tpl->tpl_vars['REASON_TO_EDIT']->value) {?>style="margin-right: 15px;"<?php }?>><small><?php echo vtranslate('LBL_COMMENT',$_smarty_tpl->tpl_vars['MODULE_NAME']->value);?>
...
" rows="<?php echo $_smarty_tpl->tpl_vars['COMMENT_TEXTAREA_DEFAULT_ROWS']->value;?>
"></textarea></div><div class="float-end row"><?php if (in_array($_smarty_tpl->tpl_vars['MODULE_NAME']->value,$_smarty_tpl->tpl_vars['PRIVATE_COMMENT_MODULES']->value)) {?><div class="checkbox"><label><input type="checkbox" id="is_private" checked>&nbsp;&nbsp;<?php echo vtranslate('LBL_INTERNAL_COMMENT');?>
...
" rows="<?php echo $_smarty_tpl->tpl_vars['COMMENT_TEXTAREA_DEFAULT_ROWS']->value;?>
"></textarea></div></div><input type="hidden" name="is_private"><div class="row" style="padding-bottom: 10px;"><div class="float-end"><button class="btn btn-success btn-sm detailViewSaveComment" type="button" data-mode="edit"><?php echo vtranslate('LBL_POST',$_smarty_tpl->tpl_vars['MODULE_NAME']->value);?>
</button><a href="javascript:void(0);" class="cursorPointer closeCommentBlock cancelLink" type="reset"><?php echo vtranslate('LBL_CANCEL',$_smarty_tpl->tpl_vars['MODULE_NAME']->value);?>
</a></div></div></div></div>
<?php }
}
