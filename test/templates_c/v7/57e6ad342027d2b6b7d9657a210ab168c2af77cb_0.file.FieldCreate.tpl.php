...
/* Smarty version 4.5.7, created on 2026-09-23 21:49:50
  from '/Users/pilgrimsage/Desktop/Personal/vtigercrm/layouts/v7/modules/Settings/LayoutEditor/FieldCreate.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.7',
  'unifunc' => 'content_6ab4497ec86c86_25486091',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '57e6ad342027d2b6b7d9657a210ab168c2af77cb' => 
    array (
      0 => '/Users/pilgrimsage/Desktop/Personal/vtigercrm/layouts/v7/modules/Settings/LayoutEditor/FieldCreate.tpl',
      1 => 1790087672,
      2 => 'file',
    ),
  ),
...
function content_6ab4497ec86c86_25486091 (Smarty_Internal_Template $_smarty_tpl) {
?>
...
</label><div class="controls col-sm-7"><input type="hidden" name="presence" value="1"/><div class="form-check form-switch"><input type="checkbox" class="form-check-input cursorPointer" role="switch" id="fieldPresence" name="presence" <?php if ($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->isViewable()) {?> checked <?php }
if ($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->isActiveOptionDisabled()) {?> optionDisabled = "true" disabled <?php }?> <?php if ($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->isMandatory()) {?> disabled <?php }?>data-on-text="Yes" data-off-text="No" value="<?php echo $_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('presence');?>
"/></div></div></div><?php } else { ?><input type="hidden" name="presence" value="2" /><?php }?><div class="well fieldProperty"><div class="properties"><div class="row"><div class="form-group"><label class="control-label fieldLabel col-sm-5"><?php echo vtranslate('LBL_ENABLE_OR_DISABLE_FIELD_PROP',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
