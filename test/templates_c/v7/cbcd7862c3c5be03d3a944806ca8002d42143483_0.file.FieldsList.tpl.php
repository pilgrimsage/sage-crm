<?php
/* Smarty version 4.5.7, created on 2026-09-23 21:49:50
  from '/Users/pilgrimsage/Desktop/Personal/vtigercrm/layouts/v7/modules/Settings/LayoutEditor/FieldsList.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.7',
  'unifunc' => 'content_6ab4497ec02825_56315499',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'cbcd7862c3c5be03d3a944806ca8002d42143483' => 
    array (
      0 => '/Users/pilgrimsage/Desktop/Personal/vtigercrm/layouts/v7/modules/Settings/LayoutEditor/FieldsList.tpl',
      1 => 1790087687,
      2 => 'file',
    ),
  ),
...
function content_6ab4497ec02825_56315499 (Smarty_Internal_Template $_smarty_tpl) {
...
</button></div><div class="col-sm-6"><?php if ($_smarty_tpl->tpl_vars['IS_SORTABLE']->value) {?><span class="float-end"><button class="btn btn-success saveFieldSequence" type="button" style="opacity:0;margin-right:0px;"><?php echo vtranslate('LBL_SAVE_LAYOUT',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
...
&nbsp;<div class="form-check form-switch d-inline-block align-middle"><input type="checkbox"<?php if ($_smarty_tpl->tpl_vars['BLOCK_MODEL']->value->isHidden()) {?> checked value='0' <?php } else { ?> value='1' <?php }?> class="form-check-input cursorPointer" role="switch" name="collapseBlock"data-on-text="<?php echo vtranslate('LBL_YES',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
...
"/></div></span>&nbsp;<?php if ($_smarty_tpl->tpl_vars['BLOCK_MODEL']->value->isAddCustomFieldEnabled()) {?><button class="btn btn-default addButton btn-sm addCustomField" type="button"><i class="fa fa-plus"></i>&nbsp;&nbsp;<?php echo vtranslate('LBL_ADD_CUSTOM_FIELD',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
</button>&nbsp;&nbsp;<?php }
...
</b>&nbsp;<?php if ($_smarty_tpl->tpl_vars['IS_MANDATORY']->value) {?><span class="redColor">*</span><?php }?></span><br><span class="float-end" style="opacity:0.6;"><?php echo vtranslate($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->getFieldDataTypeLabel(),$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
...
"><span class="mandatory switch text-capitalize <?php if ((!$_smarty_tpl->tpl_vars['IS_MANDATORY']->value)) {?>disabled<?php }?> <?php if ($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->isMandatoryOptionDisabled()) {?> cursorPointerNotAllowed <?php } else { ?> cursorPointer <?php }?>"data-bs-toggle="tooltip" <?php if ($_smarty_tpl->tpl_vars['IS_MANDATORY']->value) {?> title="<?php echo $_smarty_tpl->tpl_vars['NOT_M_FIELD_TITLE']->value;?>
...
if ($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->isQuickCreateOptionDisabled() || $_smarty_tpl->tpl_vars['IS_MANDATORY']->value) {?> cursorPointerNotAllowed <?php } else { ?> cursorPointer <?php }?>"data-bs-toggle="tooltip" <?php if ($_smarty_tpl->tpl_vars['IS_QUICK_EDIT_ENABLED']->value) {?> title="<?php echo $_smarty_tpl->tpl_vars['NOT_Q_FIELD_TITLE']->value;?>
...
if ($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->isMassEditOptionDisabled()) {?> cursorPointerNotAllowed <?php } else { ?> cursorPointer <?php }?>"data-bs-toggle="tooltip" <?php if ($_smarty_tpl->tpl_vars['IS_MASS_EDIT_ENABLED']->value) {?> title="<?php echo $_smarty_tpl->tpl_vars['NOT_M_E_FIELD_TITLE']->value;?>
...
if ($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->isHeaderFieldOptionDisabled()) {?> cursorPointerNotAllowed <?php } else { ?> cursorPointer <?php }?>"data-bs-toggle="tooltip" <?php if ($_smarty_tpl->tpl_vars['IS_HEADER_FIELD']->value) {?> title="<?php echo $_smarty_tpl->tpl_vars['NOT_H_FIELD_TITLE']->value;?>
...
if ($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->isSummaryFieldOptionDisabled()) {?> cursorPointerNotAllowed <?php } else { ?> cursorPointer <?php }?>"data-bs-toggle="tooltip" <?php if ($_smarty_tpl->tpl_vars['IS_SUMMARY_VIEW_ENABLED']->value) {?> title="<?php echo $_smarty_tpl->tpl_vars['NOT_S_FIELD_TITLE']->value;?>
...
"></i></a><?php }
if ($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->isCustomField() == 'true') {?><a href="javascript:void(0)" class="deleteCustomField float-end" data-field-id="<?php echo $_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('id');?>
...
"></i>&nbsp; <?php echo vtranslate('LBL_COLLAPSE_BLOCK',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
&nbsp;<div class="form-check form-switch d-inline-block align-middle"><input type="checkbox"<?php if ($_smarty_tpl->tpl_vars['BLOCK_MODEL']->value->isHidden()) {?> checked value='0' <?php } else { ?> value='1' <?php }?> class="form-check-input cursorPointer" role="switch" id="hiddenCollapseBlock" name=""data-on-text="<?php echo vtranslate('LBL_YES',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
" data-off-text="<?php echo vtranslate('LBL_NO',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
" data-on-color="primary" data-block-id="<?php echo $_smarty_tpl->tpl_vars['BLOCK_MODEL']->value->get('id');?>
"/></div></span>&nbsp;<button class="btn btn-default addButton addCustomField" type="button"><i class="fa fa-plus"></i>&nbsp;&nbsp;<?php echo vtranslate('LBL_ADD_CUSTOM_FIELD',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
...
"/><?php }?></span><div class="col-sm-9" style="word-wrap: break-word;"><div class="fieldLabelContainer row"><span class="fieldLabel"><b></b>&nbsp;</span><div><span class="float-end fieldTypeLabel" style="opacity:0.6;"></span></div></div></div></div></div></div><div class="col-sm-8 fieldPropertyContainer"><div class="row " style="padding:10px 0px"><div class="fieldProperties col-sm-10" data-field-id=""><span class="mandatory switch text-capitalize"><i class="fa fa-exclamation-circle" data-name="mandatory" data-enable-value="M" data-disable-value="O" title="<?php echo vtranslate('LBL_MANDATORY',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
...
"></i></a><a href="javascript:void(0)" class="deleteCustomField float-end"><i class="fa fa-trash" title="<?php echo vtranslate('LBL_DELETE',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
...
?><div class="modal-dialog inactiveFieldsModal hide"><div class="modal-header"><button type="button" class="close" data-bs-dismiss="modal" aria-hidden="true">&times;</button><h3><?php echo vtranslate('LBL_INACTIVE_FIELDS',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
</h3></div><div class="modal-content"><form class="form-horizontal inactiveFieldsForm"><div class="modal-body"><div class="inActiveList row"><div class="col-sm-1"></div><div class="list col-sm-10"></div><div class="col-sm-1"></div></div></div><div class="modal-footer"><div class="float-end cancelLinkContainer"><a class="cancelLink" type="reset" data-bs-dismiss="modal"><?php echo vtranslate('LBL_CANCEL',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
