...
/* Smarty version 4.5.7, created on 2026-09-23 21:50:33
  from '/Users/pilgrimsage/Desktop/Personal/vtigercrm/layouts/v7/modules/Reports/ModuleHeader.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.7',
  'unifunc' => 'content_6ab449a9aa6920_58527845',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '14665cd44b8c4ba1f8bfea3690ba5d5a54e7eeed' => 
    array (
      0 => '/Users/pilgrimsage/Desktop/Personal/vtigercrm/layouts/v7/modules/Reports/ModuleHeader.tpl',
      1 => 1790019581,
      2 => 'file',
    ),
  ),
...
function content_6ab449a9aa6920_58527845 (Smarty_Internal_Template $_smarty_tpl) {
?>
...
'><h4 class="module-title float-start">&nbsp;<?php echo vtranslate($_smarty_tpl->tpl_vars['MODULE']->value,$_smarty_tpl->tpl_vars['MODULE']->value);?>
&nbsp;</h4></a></span><span><p class="current-filter-name float-start">&nbsp;<span class="fa fa-angle-right" aria-hidden="true"></span>&nbsp;<?php if ($_smarty_tpl->tpl_vars['VIEW']->value == 'Detail' || $_smarty_tpl->tpl_vars['VIEW']->value == 'ChartDetail') {
...
}?><span><p class="current-filter-name filter-name float-start"><span class="fa fa-angle-right" aria-hidden="true"></span>&nbsp;<?php if ((isset($_smarty_tpl->tpl_vars['FOLDERNAME']->value))) {
echo $_smarty_tpl->tpl_vars['FOLDERNAME']->value;
} else { ?>''<?php }?>&nbsp;</p></span><?php }?></span><span class="col-lg-5 col-md-5 float-end"><div id="appnav" class="navbar-right"><?php if ((isset($_smarty_tpl->tpl_vars['LISTVIEW_LINKS']->value['LISTVIEWBASIC']))) {
...
if ($_smarty_tpl->tpl_vars['childLinks']->value && $_smarty_tpl->tpl_vars['LISTVIEW_BASICACTION']->value->get('linklabel') == 'LBL_ADD_RECORD') {?><span class="btn-group"><button class="btn btn-default dropdown-toggle module-buttons" data-bs-toggle="dropdown" id="<?php echo $_smarty_tpl->tpl_vars['MODULE']->value;?>
