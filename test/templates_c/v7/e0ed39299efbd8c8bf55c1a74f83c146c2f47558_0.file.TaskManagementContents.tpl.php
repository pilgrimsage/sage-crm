<?php
/* Smarty version 4.5.7, created on 2026-09-23 22:04:29
  from '/Users/pilgrimsage/Desktop/Personal/vtigercrm/layouts/v7/modules/Calendar/TaskManagementContents.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.7',
  'unifunc' => 'content_6ab44ced96c865_72336480',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'e0ed39299efbd8c8bf55c1a74f83c146c2f47558' => 
    array (
      0 => '/Users/pilgrimsage/Desktop/Personal/vtigercrm/layouts/v7/modules/Calendar/TaskManagementContents.tpl',
      1 => 1790019572,
      2 => 'file',
    ),
  ),
...
function content_6ab44ced96c865_72336480 (Smarty_Internal_Template $_smarty_tpl) {
...
"><?php $_smarty_tpl->_assignInScope('STATUS', $_smarty_tpl->tpl_vars['RECORD_MODEL']->value->get('status'));?><div class="task-status float-start"><input class='statusCheckbox' type="checkbox" name="taskstatus" <?php if ($_smarty_tpl->tpl_vars['STATUS']->value == "Completed") {?> checked disabled <?php }?>/></div><div class='task-body clearfix'><div class="taskSubject float-start <?php if ($_smarty_tpl->tpl_vars['STATUS']->value == "Completed") {?> textStrike <?php }?> textOverflowEllipsis" style='width:70%;'><a class="quickPreview" data-id="<?php echo $_smarty_tpl->tpl_vars['RECORDID']->value;?>
...
if ($_smarty_tpl->tpl_vars['PICKLIST_VALUE']->value == $_smarty_tpl->tpl_vars['RECORD_MODEL']->value->get('status')) {?><div class="more float-end taskStatus picklist-<?php echo $_smarty_tpl->tpl_vars['SELECTED_PICKLIST_FIELDMODEL']->value->getId();?>
-<?php echo $_smarty_tpl->tpl_vars['PICKLIST_KEY']->value;?>
"><?php echo $_smarty_tpl->tpl_vars['RECORD_MODEL']->value->get('status');?>
</div><?php }
}
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?></div><div class='other-details clearfix'><div class="float-start drag-task"><img class="cursorPointerMove" src="<?php echo vimage_path('drag.png');?>
...
</a></span></span><?php }?></div><div class="more float-end cursorPointer task-actions"><a href="#" class="quickTask" id="taskPopover"><i class="fa fa-pencil-square-o icon"></i></a>&nbsp;&nbsp;<a href="#" class="taskDelete"><i class="fa fa-trash icon"></i></a></div></div></div></div><?php
}
