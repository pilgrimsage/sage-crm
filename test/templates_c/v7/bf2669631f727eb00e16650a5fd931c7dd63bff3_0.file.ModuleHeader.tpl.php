...
/* Smarty version 4.5.7, created on 2026-09-23 21:19:15
  from '/Users/pilgrimsage/Desktop/Personal/vtigercrm/layouts/v7/modules/Calendar/ModuleHeader.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.7',
  'unifunc' => 'content_6ab44253dced54_66137701',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'bf2669631f727eb00e16650a5fd931c7dd63bff3' => 
    array (
      0 => '/Users/pilgrimsage/Desktop/Personal/vtigercrm/layouts/v7/modules/Calendar/ModuleHeader.tpl',
      1 => 1790019572,
      2 => 'file',
    ),
  ),
...
function content_6ab44253dced54_66137701 (Smarty_Internal_Template $_smarty_tpl) {
...
if ($_smarty_tpl->tpl_vars['RECORD']->value && $_smarty_tpl->tpl_vars['REQ']->value->get('view') == 'Edit') {?><p class="current-filter-name filter-name float-start "><span class="fa fa-angle-right float-start" aria-hidden="true"></span><a title="<?php echo $_smarty_tpl->tpl_vars['RECORD']->value->get('label');?>
...
">&nbsp;<?php echo $_smarty_tpl->tpl_vars['RECORD']->value->get('label');?>
&nbsp;</a></p><?php }?></div><div class="col-lg-5 col-md-5 float-end"><div id="appnav" class="navbar-right"><ul class="nav navbar-nav"><?php
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);
if (smarty_modifier_count($_smarty_tpl->tpl_vars['MODULE_SETTING_ACTIONS']->value) > 0) {?><li><div class="settingsIcon"><button type="button" class="btn btn-default module-buttons dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false"><span class="fa fa-wrench" aria-hidden="true" title="<?php echo vtranslate('LBL_SETTINGS',$_smarty_tpl->tpl_vars['MODULE']->value);?>
