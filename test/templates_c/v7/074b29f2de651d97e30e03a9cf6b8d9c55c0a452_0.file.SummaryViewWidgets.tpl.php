<?php
/* Smarty version 4.5.7, created on 2026-09-23 22:02:39
  from '/Users/pilgrimsage/Desktop/Personal/vtigercrm/layouts/v7/modules/Potentials/SummaryViewWidgets.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.7',
  'unifunc' => 'content_6ab44c7fbbe084_16635804',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '074b29f2de651d97e30e03a9cf6b8d9c55c0a452' => 
    array (
      0 => '/Users/pilgrimsage/Desktop/Personal/vtigercrm/layouts/v7/modules/Potentials/SummaryViewWidgets.tpl',
      1 => 1790019572,
      2 => 'file',
    ),
  ),
...
function content_6ab44c7fbbe084_16635804 (Smarty_Internal_Template $_smarty_tpl) {
...
" /><span class="toggleButton float-start"><i class="fa fa-angle-down"></i>&nbsp;&nbsp;</span><h4 class="display-inline-block float-start"><?php echo vtranslate($_smarty_tpl->tpl_vars['DOCUMENT_WIDGET_MODEL']->value->getLabel(),$_smarty_tpl->tpl_vars['MODULE_NAME']->value);?>
</h4><?php if ($_smarty_tpl->tpl_vars['DOCUMENT_WIDGET_MODEL']->value->get('action')) {
$_smarty_tpl->_assignInScope('PARENT_ID', $_smarty_tpl->tpl_vars['RECORD']->value->getId());?><div class="float-end"><div class="dropdown"><button type="button" class="btn btn-default dropdown-toggle" data-bs-toggle="dropdown"><span class="fa fa-plus" title="<?php echo vtranslate('LBL_NEW_DOCUMENT',$_smarty_tpl->tpl_vars['MODULE_NAME']->value);?>
...
" /><span class="toggleButton float-start"><i class="fa fa-angle-down"></i>&nbsp;&nbsp;</span><h4 class="display-inline-block float-start"><?php echo vtranslate($_smarty_tpl->tpl_vars['PRODUCT_WIDGET_MODEL']->value->getLabel(),$_smarty_tpl->tpl_vars['MODULE_NAME']->value);?>
</h4><?php if ($_smarty_tpl->tpl_vars['PRODUCT_WIDGET_MODEL']->value->get('action')) {?><div class="float-end"><button class="btn addButton btn-sm btn-default createRecord" type="button" data-url="<?php echo $_smarty_tpl->tpl_vars['PRODUCT_WIDGET_MODEL']->value->get('actionURL');?>
...
" /><span class="toggleButton float-start"><i class="fa fa-angle-down"></i>&nbsp;&nbsp;</span><h4 class="display-inline-block float-start"><?php echo vtranslate($_smarty_tpl->tpl_vars['CONTACT_WIDGET_MODEL']->value->getLabel(),$_smarty_tpl->tpl_vars['MODULE_NAME']->value);?>
</h4><?php if ($_smarty_tpl->tpl_vars['CONTACT_WIDGET_MODEL']->value->get('action')) {?><div class="float-end"><button class="btn addButton btn-sm btn-default createRecord" type="button" data-url="<?php echo $_smarty_tpl->tpl_vars['CONTACT_WIDGET_MODEL']->value->get('actionURL');?>
"><i class="fa fa-plus"></i>&nbsp;&nbsp;<?php echo vtranslate('LBL_ADD',$_smarty_tpl->tpl_vars['MODULE_NAME']->value);?>
