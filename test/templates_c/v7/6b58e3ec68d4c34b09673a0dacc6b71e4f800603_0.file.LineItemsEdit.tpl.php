<?php
/* Smarty version 4.5.7, created on 2026-09-23 21:24:52
  from '/Users/pilgrimsage/Desktop/Personal/vtigercrm/layouts/v7/modules/Inventory/partials/LineItemsEdit.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.7',
  'unifunc' => 'content_6ab443a43a5a92_27116104',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '6b58e3ec68d4c34b09673a0dacc6b71e4f800603' => 
    array (
      0 => '/Users/pilgrimsage/Desktop/Personal/vtigercrm/layouts/v7/modules/Inventory/partials/LineItemsEdit.tpl',
      1 => 1790149970,
      2 => 'file',
    ),
  ),
...
function content_6ab443a43a5a92_27116104 (Smarty_Internal_Template $_smarty_tpl) {
$_smarty_tpl->_checkPlugins(array(0=>array('file'=>'/Users/pilgrimsage/Desktop/Personal/vtigercrm/vendor/smarty/smarty/libs/plugins/modifier.count.php','function'=>'smarty_modifier_count',),));
?>
...
</h4></div><div class="col-sm-9 well"><div class="row"><div class="col-sm-4"><?php if ($_smarty_tpl->tpl_vars['LINEITEM_FIELDS']->value['region_id'] && $_smarty_tpl->tpl_vars['LINEITEM_FIELDS']->value['region_id']->isEditable()) {?><span class="float-end"><i class="fa fa-info-circle"></i>&nbsp;<label><?php echo vtranslate($_smarty_tpl->tpl_vars['LINEITEM_FIELDS']->value['region_id']->get('label'),$_smarty_tpl->tpl_vars['MODULE']->value);?>
</label>&nbsp;<select class="select2" id="region_id" name="region_id" style="width: 164px;" data-org-state="<?php echo $_smarty_tpl->tpl_vars['ORG_STATE']->value;?>
"><option value="0" data-info="<?php echo Vtiger_Util_Helper::toSafeHTML(Zend_Json::encode($_smarty_tpl->tpl_vars['DEFAULT_TAX_REGION_INFO']->value));?>
...
" /><a class="fa fa-wrench d-none d-sm-block" href="index.php?module=Vtiger&parent=Settings&view=TaxIndex" target="_blank" style="vertical-align:middle;"></a></span><?php }?></div><div class="col-sm-4"><div class="float-end"><i class="fa fa-info-circle"></i>&nbsp;<label><?php echo vtranslate('LBL_CURRENCY',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
" /><input type="hidden" value="<?php echo $_smarty_tpl->tpl_vars['SELECTED_CURRENCY']->value['currency_id'];?>
" id="selectedCurrencyId" /></div></div><div class="col-sm-4"><div class="float-end"><i class="fa fa-info-circle"></i>&nbsp;<label><?php echo vtranslate('LBL_TAX_MODE',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
</strong></td><?php if ((isset($_smarty_tpl->tpl_vars['PURCHASE_COST_EDITABLE']->value))) {?><td><strong class="float-end"><?php ob_start();
...
</strong></td><?php }?><td><strong class="float-end"><?php echo vtranslate('LBL_TOTAL',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</strong></td><?php if ((isset($_smarty_tpl->tpl_vars['MARGIN_EDITABLE']->value)) && (isset($_smarty_tpl->tpl_vars['PURCHASE_COST_EDITABLE']->value))) {?><td><strong class="float-end"><?php ob_start();
...
</strong></td><?php }?><td><strong class="float-end"><?php echo vtranslate('LBL_NET_PRICE',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
</strong></button></div><?php }?></div></div><br><div class="fieldBlockContainer"><table class="table table-bordered blockContainer lineItemTable" id="lineItemResult"><tr><td width="83%"><div class="float-end"><strong><?php echo vtranslate('LBL_ITEMS_TOTAL',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</strong></div></td><td><div id="netTotal" class="float-end netTotal"><?php if (!empty($_smarty_tpl->tpl_vars['FINAL']->value['hdnSubTotal'])) {
echo $_smarty_tpl->tpl_vars['FINAL']->value['hdnSubTotal'];
} else { ?>0<?php }?></div></td></tr><?php if ($_smarty_tpl->tpl_vars['DISCOUNT_AMOUNT_EDITABLE']->value || $_smarty_tpl->tpl_vars['DISCOUNT_PERCENT_EDITABLE']->value) {?><tr><td width="83%"><span class="float-end">(-)&nbsp;<strong><a href="javascript:void(0)" id="finalDiscount"><?php echo vtranslate('LBL_OVERALL_DISCOUNT',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
)<?php } else { ?>(0)<?php }?></span></a></strong></span></td><td><span id="discountTotal_final" class="float-end discountTotal_final"><?php if ((isset($_smarty_tpl->tpl_vars['FINAL']->value['discountTotal_final'])) ? $_smarty_tpl->tpl_vars['FINAL']->value['discountTotal_final'] : '') {
...
</td><td><span class="float-end">&nbsp;%</span><input type="text" data-rule-positive=true data-rule-inventory_percentage=true id="discount_percentage_final" name="discount_percentage_final" value="<?php echo (isset($_smarty_tpl->tpl_vars['FINAL']->value['discount_percentage_final'])) ? $_smarty_tpl->tpl_vars['FINAL']->value['discount_percentage_final'] : '';?>
" class="discount_percentage_final span1 float-end discountVal <?php if ($_smarty_tpl->tpl_vars['DISCOUNT_TYPE_FINAL']->value != 'percentage') {?>hide<?php }?>" /></td></tr><?php }
...
" class="span1 float-end discount_amount_final discountVal <?php if ($_smarty_tpl->tpl_vars['DISCOUNT_TYPE_FINAL']->value != 'amount') {?>hide<?php }?>" /></td></tr><?php }?></tbody></table></div><!-- End Popup Div --></td></tr><?php }
if ($_smarty_tpl->tpl_vars['SH_PERCENT_EDITABLE']->value) {
$_smarty_tpl->_assignInScope('CHARGE_AND_CHARGETAX_VALUES', (isset($_smarty_tpl->tpl_vars['FINAL']->value['chargesAndItsTaxes'])) ? $_smarty_tpl->tpl_vars['FINAL']->value['chargesAndItsTaxes'] : NULL);?><tr><td width="83%"><span class="float-end">(+)&nbsp;<strong><a href="javascript:void(0)" id="charges"><?php echo vtranslate('LBL_CHARGES',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
} else { ?>0<?php }?>" /><span id="chargesTotalDisplay" class="float-end chargesTotalDisplay"><?php if ((isset($_smarty_tpl->tpl_vars['FINAL']->value['shipping_handling_charge'])) ? $_smarty_tpl->tpl_vars['FINAL']->value['shipping_handling_charge'] : '') {
echo $_smarty_tpl->tpl_vars['FINAL']->value['shipping_handling_charge'];
} else { ?>0<?php }?></span></td></tr><?php }?><tr><td width="83%"><span class="float-end"><strong><?php echo vtranslate('LBL_PRE_TAX_TOTAL',$_smarty_tpl->tpl_vars['MODULE']->value);?>
 </strong></span></td><td><?php $_smarty_tpl->_assignInScope('PRE_TAX_TOTAL', ((string)((isset($_smarty_tpl->tpl_vars['FINAL']->value['preTaxTotal'])) ? $_smarty_tpl->tpl_vars['FINAL']->value['preTaxTotal'] : '')));?><span class="float-end" id="preTaxTotal"><?php if ($_smarty_tpl->tpl_vars['PRE_TAX_TOTAL']->value) {
...
echo $_smarty_tpl->tpl_vars['PRE_TAX_TOTAL']->value;
} else { ?>0<?php }?>"/></td></tr><!-- Group Tax - starts --><tr id="group_tax_row" valign="top" class="<?php if ($_smarty_tpl->tpl_vars['IS_INDIVIDUAL_TAX_TYPE']->value) {?>hide<?php }?>"><td width="83%"><span class="float-end">(+)&nbsp;<strong><a href="javascript:void(0)" id="finalTax"><?php echo vtranslate('LBL_TAX',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
" /></table></div><!-- End Popup Div Group Tax --></td><td><span id="tax_final" class="float-end tax_final"><?php if ((isset($_smarty_tpl->tpl_vars['FINAL']->value['tax_totalamount'])) ? $_smarty_tpl->tpl_vars['FINAL']->value['tax_totalamount'] : '') {
echo $_smarty_tpl->tpl_vars['FINAL']->value['tax_totalamount'];
} else { ?>0<?php }?></span></td></tr><!-- Group Tax - ends --><?php if ($_smarty_tpl->tpl_vars['SH_PERCENT_EDITABLE']->value) {?><tr><td width="83%"><span class="float-end">(+)&nbsp;<strong><a href="javascript:void(0)" id="chargeTaxes"><?php echo vtranslate('LBL_TAXES_ON_CHARGES',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
"data-rule-positive=true data-rule-inventory_percentage=true />&nbsp;%</td><td style="text-align: right;" class="lineOnTop"><input type="text" class="span1 chargeTaxValue cursorPointer float-end chargeTax<?php echo $_smarty_tpl->tpl_vars['CHARGE_ID']->value;
...
} else { ?>0<?php }?>" /><span class="float-end" id="chargeTaxTotal"><?php if ((isset($_smarty_tpl->tpl_vars['FINAL']->value['shtax_totalamount'])) ? $_smarty_tpl->tpl_vars['FINAL']->value['shtax_totalamount'] : '') {
echo $_smarty_tpl->tpl_vars['FINAL']->value['shtax_totalamount'];
} else { ?>0<?php }?></span></td></tr><tr><td width="83%"><span class="float-end">(-)&nbsp;<strong><a href="javascript:void(0)" id="deductTaxes"><?php echo vtranslate('LBL_DEDUCTED_TAXES',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
} else { ?>0<?php }?>"data-rule-positive=true data-rule-inventory_percentage=true />&nbsp;%</td><td style="text-align: right;" class="lineOnTop"><input type="text" class="span1 deductTaxValue cursorPointer float-end" name="<?php echo $_smarty_tpl->tpl_vars['DEDUCTED_TAX_INFO']->value['taxname'];?>
_group_amount" size="5" readonly value="<?php echo $_smarty_tpl->tpl_vars['DEDUCTED_TAX_INFO']->value['amount'];?>
"/>&nbsp;</td></tr><?php
}
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?></tbody></table></div></td><td><span class="float-end" id="deductTaxesTotalAmount"><?php if ((isset($_smarty_tpl->tpl_vars['FINAL']->value['deductTaxesTotalAmount'])) && $_smarty_tpl->tpl_vars['FINAL']->value['deductTaxesTotalAmount']) {
echo $_smarty_tpl->tpl_vars['FINAL']->value['deductTaxesTotalAmount'];
} else { ?>0<?php }?></span></td></tr><?php }?><tr valign="top"><td width="83%" ><div class="float-end"><strong><?php echo vtranslate('LBL_ADJUSTMENT',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
</span></div></td><td><span class="float-end"><input id="adjustment" name="adjustment" type="text" data-rule-positive="true" class="lineItemInputBox form-control" value="<?php if ((isset($_smarty_tpl->tpl_vars['FINAL']->value['adjustment'])) && $_smarty_tpl->tpl_vars['FINAL']->value['adjustment'] < 0) {
...
} else { ?>0<?php }?>"></span></td></tr><tr valign="top"><td width="83%"><span class="float-end"><strong><?php echo vtranslate('LBL_GRAND_TOTAL',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</strong></span></td><td><span id="grandTotal" name="grandTotal" class="float-end grandTotal"><?php echo (isset($_smarty_tpl->tpl_vars['FINAL']->value['grandTotal'])) ? $_smarty_tpl->tpl_vars['FINAL']->value['grandTotal'] : '';?>
</span></td></tr><?php if ($_smarty_tpl->tpl_vars['MODULE']->value == 'Invoice' || $_smarty_tpl->tpl_vars['MODULE']->value == 'PurchaseOrder') {?><tr valign="top"><td width="83%" ><div class="float-end"><?php if ($_smarty_tpl->tpl_vars['MODULE']->value == 'Invoice') {?><strong><?php echo vtranslate('LBL_RECEIVED',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</strong><?php } else { ?><strong><?php echo vtranslate('LBL_PAID',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</strong><?php }?></div></td><td><?php if ($_smarty_tpl->tpl_vars['MODULE']->value == 'Invoice') {?><span class="float-end"><input id="received" name="received" type="text" class="lineItemInputBox form-control" value="<?php if ($_smarty_tpl->tpl_vars['RECORD']->value->getDisplayValue('received') && !($_smarty_tpl->tpl_vars['IS_DUPLICATE']->value)) {
echo $_smarty_tpl->tpl_vars['RECORD']->value->getDisplayValue('received');
} else { ?>0<?php }?>"></span><?php } else { ?><span class="float-end"><input id="paid" name="paid" type="text" class="lineItemInputBox" value="<?php if ($_smarty_tpl->tpl_vars['RECORD']->value->getDisplayValue('paid') && !($_smarty_tpl->tpl_vars['IS_DUPLICATE']->value)) {
echo $_smarty_tpl->tpl_vars['RECORD']->value->getDisplayValue('paid');
} else { ?>0<?php }?>"></span><?php }?></td></tr><tr valign="top"><td width="83%" ><div class="float-end"><strong><?php echo vtranslate('LBL_BALANCE',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</strong></div></td><td><span class="float-end"><input id="balance" name="balance" type="text" class="lineItemInputBox form-control" value="<?php if ($_smarty_tpl->tpl_vars['RECORD']->value->getDisplayValue('balance') && !($_smarty_tpl->tpl_vars['IS_DUPLICATE']->value)) {
