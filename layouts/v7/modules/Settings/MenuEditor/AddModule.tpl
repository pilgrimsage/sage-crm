	...
	<div class="modal-dialog modal-lg addModuleContainer">
		<div class="modal-content">
			...
			<div class="modal-header" >
				<div class="clearfix">
					<div class="float-end">
						<button type="button" class="close" aria-label="Close" data-bs-dismiss="modal" style="color: inherit;">
							<span aria-hidden="true" class='fa fa-close'></span>
						</button>
					</div>
					<div class="btn-group">
						{assign var=APP_SELECTED_LABEL value="LBL_SELECT_`$SELECTED_APP_NAME`_MODULES"}
						<h4 class="float-start textOverflowEllipsis" style="word-break: break-all;max-width: 95%;">{vtranslate($APP_SELECTED_LABEL, $QUALIFIED_MODULE)}&nbsp;&nbsp;</h4>  
					</div>
				</div>
			</div>
