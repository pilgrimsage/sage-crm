                ...
                <div class="modal-body" id="scrollContainer">
                    <div class="">
                        ...
                        <div class="block row nameContainer">
                            ...
                            <div class="col-lg-3"><label class="float-end">{vtranslate('LBL_CHARGE_NAME', $QUALIFIED_MODULE)}&nbsp;<span class="redColor">*</span></label></div>
                            <div class="col-lg-5">
                        ...
                        <div class="row block formatContainer">
                            <div class="col-lg-1"></div>
                            <div class="col-lg-3"><label class="float-end">{vtranslate('LBL_CHARGE_FORMAT', $QUALIFIED_MODULE)}</label></div>
                            <div class="col-lg-5">
                        ...
                        <div class="row block typeContainer">
                            <div class="col-lg-1"></div>
                            <div class="col-lg-3">
                                <label class="float-end">{vtranslate('LBL_CHARGE_TYPE', $QUALIFIED_MODULE)}</label>
                            </div>
                            <div class="col-lg-7">
                        ...
                        <div class="row block chargeValueContainer {if $CHARGE_MODEL->get('type') eq 'Variable'}hide{/if}">
                            <div class="col-lg-1"></div>
                            <div class="col-lg-3">
                                <label class="float-end">{vtranslate('LBL_CHARGE_VALUE', $QUALIFIED_MODULE)}&nbsp;<span class="redColor">*</span></label>
                            </div>
                            <div class="col-lg-5">
                                <div class="input-group">
                                    {assign var=CHARGE_VALUE value="{if $CHARGE_MODEL->getValue()}{number_format({$CHARGE_MODEL->getValue()}, getCurrencyDecimalPlaces(),'.','')}{else}0{/if}"}
                                     <span style="height:30px;width:30px;" class="input-group-addon percentIcon float-start {if !$IS_PERCENT_FORMAT}hide{/if}">%</span>
                        ...
                        <div class="row block">
                            <div class="col-lg-1"></div>
                            <div class="col-lg-3"><label class="float-end">{vtranslate('LBL_IS_TAXABLE', $QUALIFIED_MODULE)}</label></div>
                            <div class="col-lg-7">
                        ...
                        <div class="row block taxContainer {if $CHARGE_MODEL->get('istaxable') neq 1 AND $CHARGE_ID}hide{/if}">
                            <div class="col-lg-1"></div>
                            <div class="col-lg-3">
                                <label class="float-end">{vtranslate('LBL_SELECT_TAX', $QUALIFIED_MODULE)}&nbsp;<span class="redColor">*</span></label>
                            </div>
                            <div class="col-lg-7">
                                <div class="">
