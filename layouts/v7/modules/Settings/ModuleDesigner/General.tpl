<h2><img src="layouts/v7/modules/Settings/{$MODULE}/resources/images/template.png" alt="{vtranslate('LBL_TEMPLATE_ALT', $QUALIFIED_MODULE)}" /> {vtranslate('LBL_TEMPLATE', $QUALIFIED_MODULE)}</h2>
...
<h2><img src="layouts/v7/modules/Settings/{$MODULE}/resources/images/module.png" alt="{vtranslate('LBL_MODULE_ALT', $QUALIFIED_MODULE)}" /> {vtranslate('LBL_MODULE', $QUALIFIED_MODULE)}</h2>
...
<tr>
	...
	<td>
		<a href="javascript:showLoadModulePopup()"><img src="layouts/v7/modules/Settings/{$MODULE}/resources/images/load.png" alt="{vtranslate('LBL_LOAD_MODULE_ALT', $QUALIFIED_MODULE)}" title="{vtranslate('LBL_LOAD_MODULE', $QUALIFIED_MODULE)}" /></a> &nbsp;
		<a href="javascript:showUploadModulePopup()"><img src="layouts/v7/modules/Settings/{$MODULE}/resources/images/upload.png" alt="{vtranslate('LBL_UPLOAD_MODULE_ALT', $QUALIFIED_MODULE)}" title="{vtranslate('LBL_UPLOAD_MODULE', $QUALIFIED_MODULE)}" /></a>
	</td>
</tr>
<tr>
...
<h2><img src="layouts/v7/modules/Settings/{$MODULE}/resources/images/menu.png" alt="{vtranslate('LBL_PARENT_TAB_ALT', $QUALIFIED_MODULE)}" /> {vtranslate('LBL_PARENT_TAB', $QUALIFIED_MODULE)}</h2>
